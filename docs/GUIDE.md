...
- **Сверху** — день недели и дата. По умолчанию виджет показывает ближайший учебный день: «Завтра» или, например, «Понедельник» в пятницу.
...
- **Переключатель внизу** — «Сегодня» или следующий день. В режиме «Сегодня» текущий урок выделен цветом, прошедшие — бледнее.
