...
**Teacher Companion / «Помощник учителя»** работает с вашей обычной учебной неделей. Утром виджет показывает сегодняшние уроки, а после последнего урока — ближайший день с занятиями. Суббота и воскресенье — выходные.
...
Первый запуск проведёт через звонки, расписание и внешний вид. Можно пропустить заполнение и вернуться к нему позже. Расписание сохраняется автоматически; правки с ошибками хранятся черновиком, а программа сама делает резервные копии при обновлении и раз в день. Новые версии можно ставить прямо из программы — по желанию.
...
**Текущая версия — 0.5.0:** автосохранение, черновики, автоматические резервные копии и обновление из программы по желанию. Версия 0.2.0 стала первой стабильной: этапы 1–6 завершены, приложение собрано и прошло ручную приёмку на Windows: установка и обновление, хранение расписания, виджет и его положение, трей, автозапуск, темы, резервные копии и работа без интернета. Автоматические тесты и сборка также проходят успешно.
...
Нет регистрации, облачной синхронизации, телеметрии и отправки расписания на сервер. В сеть приложение обращается только за файлом `latest.json` на GitHub, чтобы узнать о новой версии; это выключается в настройках. Обновления подписаны ключом автора и проверяются перед установкой.
